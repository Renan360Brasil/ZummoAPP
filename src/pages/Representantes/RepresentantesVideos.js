...
export default class RepresentantesVideos extends Component {
  ...
  getDataUsingGet = (title, url) => {
    ...
    fetch(
      `https://tinyurl.com/api-create.php?url=https://www.zummo.com.br/_app/view_video.php?video=${url}&folder=representantes_videos`,
      {
        method: 'GET',
      },
    )
      ...
      <View style={styles.productContainer}>
        <TouchableOpacity
          ...
          <Image
            ...
            source={{
              uri:
                'https://www.zummo.com.br/_app/uploads/representantes_videos/' +
                item.thumb,
            }}
            resizeMode={'contain'}
          />
