        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.viewButtons}>
            <TouchableOpacity
              style={styles.btnMenu}
              onPress={() => {
                this.props.navigation.push("Representantes");
              }}
            >
              <Image source={btnRepresentantes} style={styles.imgBtn} />
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.btnMenu}
              onPress={() => {
                this.props.navigation.push("Pecas");
              }}
            >
              <Image source={btnPecas} style={styles.imgBtn} />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.viewButtons}>
            <TouchableOpacity
              style={styles.btnMenu}
              onPress={() => {
                this.props.navigation.push("RAT");
              }}
            >
              <Image source={btnRAT} style={styles.imgBtn} />
            </TouchableOpacity>
          </View>
